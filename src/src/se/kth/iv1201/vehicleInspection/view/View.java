...
import se.kth.iv1201.vehicleInspection.log.Logger;
...
public class View {
     ...
     */
    public void start() throws IllegalLicenceNumberException {
        ...
        while (true) {
            ...
            try {
                ...
                if(status == false){
                    controller.storeFinalResult(status);
                }else{
                    controller.storeFinalResult(status);
                }
                ...
                System.out.println("Would like you continue with another inspection? [y/n]");
                String inspection = reader.next();

                if(inspection.equalsIgnoreCase("n")){
                    System.exit(1);
                }

            } catch (IllegalLicenceNumberException e) {
                logger.writeToLog(e);
                System.out.println("No inspection found with that registration number");
            }
